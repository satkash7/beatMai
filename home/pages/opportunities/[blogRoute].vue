  ...
  <div class="w-full pt-16">
    <div class="container mx-auto px-4 md:px-6">
      ...
      <div v-else-if="details" class="max-w-4xl mx-auto">
        <!-- Back Button -->
        <div class="mb-6">
          <a href="/opportunities" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium transition-colors">
        ...
        <div class="flex flex-wrap items-center gap-3 mb-4">
          ...
          <span v-if="details.realnames" class="text-gray-500 dark:text-gray-400 text-sm">
            par {{ details.realnames }}
          </span>
        </div>
        ...
        <div class="border-t border-gray-200 dark:border-dark-border pt-6 mb-10">
          <h3 class="text-lg font-semibold text-gray-800 dark:text-dark-text mb-4">Partager cette opportunité</h3>
      ...
      <div v-else class="text-center py-20">
        <h2 class="text-2xl font-bold text-gray-700 dark:text-gray-300 mb-4">Opportunité introuvable</h2>
        <p class="text-gray-500 dark:text-gray-400 mb-6">Cette opportunité n'existe pas ou a été supprimée.</p>
        <a href="/opportunities" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
