    ...
    <div class="container mx-auto px-4 md:px-6">
      <section class="text-center py-8 mb-8">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-dark-text mb-3">
          Nos <span class="text-blue-600">Publications</span>
        </h1>
      ...
      <section>
          ...
          <article v-for="blogItem in paginatedBlogs" :key="blogItem.id"
            ...
            <div class="h-48 overflow-hidden">
              <a :href="'/blogs/' + blogItem.blogRoute" class="block">
                <img :src="blogItem.imageUrl || defaultImg" :alt="blogItem.blogTitle"
        ...
        <div v-if="!loading && !blogs.length" class="text-center py-12">
          <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Aucune publication disponible</h3>
          <p class="text-gray-500 dark:text-gray-400">Revenez plus tard pour découvrir de nouveaux articles.</p>
        </div>
