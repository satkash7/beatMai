exports.ids = [6];
exports.modules = Array(74).concat([
/* 74 */
...
var map = {
	"./ai.jpg": 74,
	"./bg-trading-tools.png": 43,
	"./bg1.jpg": 100,
	"./bg2.jpg": 101,
	"./bg3.jpg": 102,
	"./cafod.webp": 20,
	"./caritas.png": 103,
	"./country-icon/eng.png": 104,
	"./crypto-icon/2share.png": 105,
	"./crypto-icon/bitcoin-asia.png": 106,
	"./crypto-icon/bitcoin.png": 107,
	"./crypto-icon/dogecoin.png": 108,
	"./crypto-icon/ethereum.png": 109,
	"./crypto-icon/frog.png": 110,
	"./crypto-icon/metacraft.png": 111,
	"./crypto-icon/moonrock.png": 112,
	"./crypto-icon/musk-doge.png": 113,
	"./crypto-icon/ninjafloki.png": 114,
	"./crypto-icon/pappay.png": 115,
	"./crypto-icon/solana.png": 116,
	"./documentation.jpg": 117,
	"./entreprenariat.png": 118,
	"./getting-started/arrow.png": 119,
	"./getting-started/doccs.png": 120,
	"./getting-started/stats.png": 121,
	"./getting-started/training.png": 122,
	"./getting-started/trend.png": 123,
	"./logo/logo.png": 19,
	"./olame.jpeg": 41,
	"./partner/background.png": 42,
	"./pattern/ellipse-1.png": 124,
	"./pattern/ellipse-2.png": 125,
	"./pattern/ellipse-3.png": 126,
	"./pattern/star.png": 127,
	"./pic1.jpg": 36,
	"./pic2.jpg": 37,
	"./pic3.jpg": 38,
	"./pic4.jpg": 39,
...
var render = function render() {
  ...
  return _c('client-only', [_c('div', {
    ...
    attrs: {
      "src": __webpack_require__(90)(`./${_vm.exchangeSelected.img}`),
      "alt": ""
    }
  }), _vm._v(" "), _c('span', {
    ...
    return _c('li', {
      ...
      staticClass: "flex-shrink-0 h-6 w-6 rounded-full",
      attrs: {
        "src": __webpack_require__(90)(`./${exchange.img}`),
        "alt": ""
      }
    }), _vm._v(" "), _c('span', {
