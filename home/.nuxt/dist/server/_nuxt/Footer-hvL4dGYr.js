...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-[320px] xl:max-w-[380px] bg-white dark:bg-dark-card shadow-md rounded-lg overflow-hidden transition-transform duration-500 hover:scale-105 hover:shadow-xl ml-5 mr-5 border border-transparent dark:border-dark-border" }, _attrs))}><div class="relative"><a${ssrRenderAttr("href", "/blogs/" + $props.blog.blogRoute)} class="block"><img${ssrRenderAttr("src", $props.blog.imageUrl)} class="w-full h-48 object-cover rounded-t-lg transition-opacity duration-500 ease-in-out hover:opacity-80"${ssrRenderAttr("alt", $props.blog.blogTitle)}></a></div><div class="p-4"><a${ssrRenderAttr("href", "/blogs/" + $props.blog.blogRoute)} class="block"><h3 class="text-lg font-bold text-gray-800 dark:text-dark-text hover:text-blue-500 transition-all duration-300 mb-3">${ssrInterpolate($props.blog.blogTitle)}</h3><p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed line-clamp-3">${ssrInterpolate($props.blog.blogCaption)}</p></a><div class="mt-4 pt-3 border-t border-gray-100 dark:border-dark-border"><a${ssrRenderAttr("href", "/blogs/" + $props.blog.blogRoute)} class="text-blue-600 hover:text-blue-800 font-medium flex items-center justify-center transition-colors duration-300 group"> Lire la suite <svg class="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a></div></div></div>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "max-w-screen-xl px-4 md:px-8 mx-auto mb-0" }, _attrs))} data-v-4637324e>`);
  if ($props.isHomepage) {
    _push(`<section class="bg-white dark:bg-dark-card relative max-w-full sm:mx-4 xl:mx-10 my-12 md:my-16 shadow-lg rounded-xl overflow-hidden border border-gray-200 dark:border-dark-border" data-v-4637324e><div class="w-full py-8 md:py-12 flex flex-col items-center" data-v-4637324e><h2 class="text-2xl md:text-3xl font-semibold text-center text-gray-800 dark:text-dark-text mb-6 md:mb-8" data-v-4637324e> Nos actualités les plus récentes </h2><div class="relative w-full flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 px-4 xl:px-8" data-v-4637324e><!--[-->`);
  ...
  _push(`<section class="partners-section py-10 md:py-14 bg-gray-50 dark:bg-dark-surface" data-v-4637324e><div class="max-w-6xl mx-auto text-center" data-v-4637324e><h2 class="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-8" data-v-4637324e> Nos partenaires </h2><div class="relative" data-v-4637324e><div class="pointer-events-none absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-gray-50 dark:from-dark-surface to-transparent z-10" data-v-4637324e></div><div class="pointer-events-none absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-gray-50 dark:from-dark-surface to-transparent z-10" data-v-4637324e></div><div class="flex items-center gap-8 overflow-x-auto pb-6 px-4 hide-scrollbar partners-scroll-container" data-v-4637324e><!--[-->`);
  ssrRenderList($data.partners, (partner) => {
    _push(`<a${ssrRenderAttr("href", partner.link)} target="_blank" rel="noopener noreferrer" class="partner-logo flex-shrink-0 bg-white dark:bg-dark-card rounded-xl shadow-sm hover:shadow-md transition-all duration-300 px-6 py-4 border border-transparent dark:border-dark-border" data-v-4637324e><img${ssrRenderAttr("src", partner.logo)} class="h-16 md:h-20 object-contain mx-auto transition-transform duration-300 hover:scale-105"${ssrRenderAttr("alt", partner.name)} data-v-4637324e></a>`);
  });
  _push(`<!--]--></div><div class="md:hidden text-xs text-gray-500 mt-3 flex items-center justify-center gap-2" data-v-4637324e>`);
  ...
  _push(`<span data-v-4637324e>Swipe or let it scroll automatically</span></div></div></div></section>`);
  if ($props.isHomepage) {
    _push(`<section id="contact" class="bg-white dark:bg-dark-card relative max-w-full sm:mx-4 my-12 md:my-16 py-8 md:py-12 shadow-lg rounded-xl border border-gray-200 dark:border-dark-border" data-v-4637324e><div class="max-w-6xl mx-auto px-4" data-v-4637324e><div class="text-center mb-8 md:mb-10" data-v-4637324e><h2 class="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-4" data-v-4637324e>Contactez-nous</h2><p class="text-gray-600 dark:text-gray-400 mb-6" data-v-4637324e> Nous sommes à votre écoute pour répondre à toutes vos questions </p><div class="flex flex-col md:flex-row justify-center space-y-2 md:space-y-0 md:space-x-8 text-sm md:text-base" data-v-4637324e><div class="flex items-center justify-center" data-v-4637324e>`);
    _push(ssrRenderComponent(_component_MapPinIcon, {
      size: 18,
      class: "text-blue-600 mr-2"
    }, null, _parent));
    _push(`<span data-v-4637324e>Goma, Nord-Kivu, RDC</span></div><div class="flex items-center justify-center" data-v-4637324e>`);
    _push(ssrRenderComponent(_component_PhoneIcon, {
      size: 18,
      class: "text-blue-600 mr-2"
    }, null, _parent));
    _push(`<span data-v-4637324e>+243 995 277 023</span></div><div class="flex items-center justify-center" data-v-4637324e>`);
    _push(ssrRenderComponent(_component_EmailIcon, {
      size: 18,
      class: "text-blue-600 mr-2"
    }, null, _parent));
    _push(`<span data-v-4637324e>direction@beatexpertise.com</span></div></div></div><div class="flex flex-col lg:flex-row gap-8" data-v-4637324e><form class="lg:w-1/2 max-w-lg mx-auto lg:mx-0 bg-gray-50 dark:bg-dark-surface p-6 md:p-8 rounded-xl" data-v-4637324e>`);
    if ($data.addedRequest) {
      _push(`<div class="bg-green-100 text-green-700 px-4 py-3 rounded-md mb-4 flex items-center" data-v-4637324e>`);
      _push(ssrRenderComponent(_component_CheckCircleIcon, {
        size: 20,
        class: "mr-2"
      }, null, _parent));
      _push(`<span data-v-4637324e>Votre message a été envoyé avec succès. Nous vous contacterons bientôt.</span></div>`);
    } else {
      _push(`<!---->`);
    }
    if ($data.failedRequest) {
      _push(`<div class="bg-orange-100 text-orange-700 px-4 py-3 rounded-md mb-4 flex items-center" data-v-4637324e>`);
      _push(ssrRenderComponent(_component_AlertCircleIcon, {
        size: 20,
        class: "mr-2"
      }, null, _parent));
      _push(`<span data-v-4637324e>Une erreur est survenue, veuillez réessayer plus tard.</span></div>`);
    } else {
      _push(`<!---->`);
    }
    _push(`<div class="space-y-4" data-v-4637324e><div data-v-4637324e><label class="block text-sm font-medium text-gray-700 mb-1" data-v-4637324e>Votre nom ou organisation</label><input type="text" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Votre nom complet"${ssrRenderAttr("value", $data.visitorname)} required data-v-4637324e></div><div data-v-4637324e><label class="block text-sm font-medium text-gray-700 mb-1" data-v-4637324e>Adresse email *</label><input type="email" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="exemple@email.com"${ssrRenderAttr("value", $data.visitoremail)} required data-v-4637324e></div><div data-v-4637324e><label class="block text-sm font-medium text-gray-700 mb-1" data-v-4637324e>Votre message</label><textarea rows="4" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Comment pouvons-nous vous aider ?" required data-v-4637324e>${ssrInterpolate($data.visitormessage)}</textarea></div><div data-v-4637324e><label class="block text-sm font-medium text-gray-700 mb-1" data-v-4637324e>Numéro de téléphone (optionnel)</label><input type="tel" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="+243 XXX XXX XXX"${ssrRenderAttr("value", $data.visitorphone)} data-v-4637324e></div><button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center" data-v-4637324e>`);
    _push(ssrRenderComponent(_component_SendIcon, {
      size: 18,
      class: "mr-2"
    }, null, _parent));
    _push(` Envoyer le message </button></div></form><div class="lg:w-1/2" data-v-4637324e><div class="bg-gray-100 rounded-xl overflow-hidden shadow-md h-full" data-v-4637324e><div class="p-4 bg-blue-600 text-white" data-v-4637324e><h3 class="font-semibold flex items-center" data-v-4637324e>`);
    _push(ssrRenderComponent(_component_MapPinIcon, {
      size: 20,
      class: "mr-2"
    }, null, _parent));
    _push(` Localisation de notre bureau </h3><p class="text-sm mt-1" data-v-4637324e>Goma, Nord-Kivu, République Démocratique du Congo</p></div><div class="h-80 md:h-96" data-v-4637324e><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4085951.67416805!2d26.553710875!3d-1.239759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19da4dce0d5d7c3f%3A0x1e3e5f5f5f5f5f5f!2sGoma%2C%20Nord-Kivu%2C%20R%C3%A9publique%20D%C3%A9mocratique%20du%20Congo!5e0!3m2!1sfr!2sus!4v1633456789012!5m2!1sfr!2sus" width="100%" height="100%" style="${ssrRenderStyle({ "border": "0" })}" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-b-xl" data-v-4637324e></iframe></div><div class="p-4 bg-gray-50 text-center" data-v-4637324e><p class="text-sm text-gray-600" data-v-4637324e>`);
  ...
  _push(`<div class="py-8 md:py-10 border-t border-gray-200 dark:border-dark-border" data-v-4637324e><div class="flex flex-col md:flex-row justify-between items-start gap-8" data-v-4637324e><div class="flex flex-col items-center md:items-start text-center md:text-left max-w-md mx-auto md:mx-0" data-v-4637324e><a href="/" class="mb-4" data-v-4637324e><img${ssrRenderAttr("src", $data.logoImg)} class="w-28 md:w-32 object-contain" alt="Beat Expertise Logo" data-v-4637324e></a><p class="text-gray-600 dark:text-gray-400 text-sm md:text-base" data-v-4637324e> BEAT est un bureau d&#39;expertise et accompagnement technique basé à Goma, dédié à offrir des solutions innovantes pour le développement technologique de la région. </p></div><nav class="flex flex-col items-center md:items-start space-y-3 text-gray-700 dark:text-gray-300 mx-auto md:mx-0" data-v-4637324e><h3 class="font-semibold text-gray-800 dark:text-dark-text mb-2 text-center md:text-left" data-v-4637324e>Navigation</h3><a href="/blogs" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-4637324e>Actualités</a><a href="/#mission" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-4637324e>Mission</a><a href="/#domaines" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-4637324e>Domaines</a><a href="/opportunities" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-4637324e>Offres &amp; Opportunités</a><a href="/apropos" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-4637324e>À propos de nous</a></nav><div class="bg-gray-50 dark:bg-dark-surface rounded-lg p-4 md:p-6 max-w-md w-full mx-auto md:mx-0 border border-gray-200 dark:border-dark-border" data-v-4637324e><form class="space-y-3" data-v-4637324e>`);
  if ($data.addedUser) {
    _push(`<div class="bg-green-100 text-green-700 px-3 py-2 rounded-md text-xs md:text-sm flex items-center" data-v-4637324e>`);
    _push(ssrRenderComponent(_component_CheckCircleIcon, {
      size: 16,
      class: "mr-1"
    }, null, _parent));
    _push(`<span data-v-4637324e>Merci d&#39;avoir rejoint notre communauté</span></div>`);
  } else {
    _push(`<!---->`);
  }
  if ($data.userExists) {
    _push(`<div class="bg-orange-100 text-orange-700 px-3 py-2 rounded-md text-xs md:text-sm flex items-center" data-v-4637324e>`);
    _push(ssrRenderComponent(_component_AlertCircleIcon, {
      size: 16,
      class: "mr-1"
    }, null, _parent));
    _push(`<span data-v-4637324e>Cette adresse mail est déjà enregistrée</span></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<h3 class="font-semibold text-gray-800 dark:text-dark-text text-center text-sm md:text-base" data-v-4637324e>Rejoindre notre newsletter</h3><div class="flex" data-v-4637324e><input type="email" class="flex-grow px-3 md:px-4 py-2 rounded-l-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base" placeholder="Votre adresse email"${ssrRenderAttr("value", $data.email)} required data-v-4637324e><button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-3 md:px-4 py-2 rounded-r-lg transition-colors duration-300 flex items-center" data-v-4637324e>`);
  _push(ssrRenderComponent(_component_ArrowRightIcon, { size: 16 }, null, _parent));
  _push(`</button></div><p class="text-xs text-gray-500 text-center" data-v-4637324e>Restez informé de nos dernières actualités</p></form></div></div></div><div class="py-4 md:py-6 border-t border-gray-200 dark:border-dark-border" data-v-4637324e><div class="flex flex-col md:flex-row justify-between items-center gap-4" data-v-4637324e><div class="flex flex-wrap justify-center gap-2" data-v-4637324e><!--[-->`);
  ssrRenderList($data.socialLinks, (social, index) => {
    _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-icon" data-v-4637324e>`);
  ...
  _push(`<!--]--></div><div class="text-center text-gray-600 text-sm" data-v-4637324e> © ${ssrInterpolate($data.year)} <a href="/apropos" class="hover:text-blue-600 transition-colors" data-v-4637324e>Beat Expertise</a>. Tous droits réservés </div></div></div></footer>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4637324e"]]);
export {
...
//# sourceMappingURL=Footer-hvL4dGYr.js.map
