...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "max-w-screen-xl px-4 md:px-8 mx-auto mb-0" }, _attrs))} data-v-78847de2>`);
  if ($props.isHomepage) {
    _push(`<section class="bg-white dark:bg-dark-card relative max-w-full sm:mx-4 xl:mx-10 my-12 md:my-16 shadow-lg rounded-xl overflow-hidden border border-gray-200 dark:border-dark-border" data-v-78847de2><div class="w-full py-8 md:py-12 flex flex-col items-center" data-v-78847de2><h2 class="text-2xl md:text-3xl font-semibold text-center text-gray-800 dark:text-dark-text mb-6 md:mb-8" data-v-78847de2> Nos actualités les plus récentes </h2><div class="relative w-full grid grid-cols-1 lg:grid-cols-3 gap-8 px-4 xl:px-8" data-v-78847de2><!--[-->`);
  ...
  _push(`<section class="partners-section py-10 md:py-14 bg-gradient-to-b from-gray-50 to-white dark:from-[#0f172a] dark:to-[#1e293b]" data-v-78847de2><div class="max-w-6xl mx-auto text-center" data-v-78847de2><h2 class="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-8" data-v-78847de2> Nos partenaires </h2><div class="relative" data-v-78847de2><div class="pointer-events-none absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-gray-50 dark:from-[#0f172a] to-transparent z-10" data-v-78847de2></div><div class="pointer-events-none absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-gray-50 dark:from-[#0f172a] to-transparent z-10" data-v-78847de2></div><div class="flex items-center gap-8 overflow-x-auto pb-6 px-4 hide-scrollbar partners-scroll-container" data-v-78847de2><!--[-->`);
  ssrRenderList($data.partners, (partner) => {
    _push(`<a${ssrRenderAttr("href", partner.link)} target="_blank" rel="noopener noreferrer" class="partner-logo flex-shrink-0 bg-white dark:bg-dark-card rounded-xl shadow-sm hover:shadow-md transition-all duration-300 px-6 py-4 border border-transparent dark:border-dark-border" data-v-78847de2><img${ssrRenderAttr("src", partner.logo)} class="h-16 md:h-20 object-contain mx-auto transition-transform duration-300 hover:scale-105"${ssrRenderAttr("alt", partner.name)} data-v-78847de2></a>`);
  });
  _push(`<!--]--></div><div class="md:hidden text-xs text-gray-500 mt-3 flex items-center justify-center gap-2" data-v-78847de2>`);
  ...
  _push(`<span data-v-78847de2>Swipe or let it scroll automatically</span></div></div></div></section>`);
  if ($props.isHomepage) {
    _push(`<section id="contact" class="bg-white dark:bg-dark-card relative max-w-full sm:mx-4 my-12 md:my-16 py-8 md:py-12 shadow-lg rounded-xl border border-gray-200 dark:border-dark-border" data-v-78847de2><div class="max-w-6xl mx-auto px-4" data-v-78847de2><div class="text-center mb-8 md:mb-10" data-v-78847de2><h2 class="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-4" data-v-78847de2>Contactez-nous</h2><p class="text-gray-600 dark:text-gray-400 mb-6" data-v-78847de2> Nous sommes à votre écoute pour répondre à toutes vos questions </p><div class="flex flex-col md:flex-row justify-center space-y-2 md:space-y-0 md:space-x-8 text-sm md:text-base" data-v-78847de2><div class="flex items-center justify-center" data-v-78847de2>`);
    _push(ssrRenderComponent(_component_MapPinIcon, {
      size: 18,
      class: "text-blue-600 mr-2"
    }, null, _parent));
    _push(`<span data-v-78847de2>Goma, Nord-Kivu, RDC</span></div><div class="flex items-center justify-center" data-v-78847de2>`);
    _push(ssrRenderComponent(_component_PhoneIcon, {
      size: 18,
      class: "text-blue-600 mr-2"
    }, null, _parent));
    _push(`<span data-v-78847de2>+243 995 277 023</span></div><div class="flex items-center justify-center" data-v-78847de2>`);
    _push(ssrRenderComponent(_component_EmailIcon, {
      size: 18,
      class: "text-blue-600 mr-2"
    }, null, _parent));
    _push(`<span data-v-78847de2>direction@beatexpertise.com</span></div></div></div><div class="flex flex-col lg:flex-row gap-8" data-v-78847de2><form class="lg:w-1/2 max-w-lg mx-auto lg:mx-0 bg-gray-50 dark:bg-dark-surface p-6 md:p-8 rounded-xl" data-v-78847de2>`);
    if ($data.addedRequest) {
      _push(`<div class="bg-green-100 text-green-700 px-4 py-3 rounded-md mb-4 flex items-center" data-v-78847de2>`);
      _push(ssrRenderComponent(_component_CheckCircleIcon, {
        size: 20,
        class: "mr-2"
      }, null, _parent));
      _push(`<span data-v-78847de2>Votre message a été envoyé avec succès. Nous vous contacterons bientôt.</span></div>`);
    } else {
      _push(`<!---->`);
    }
    if ($data.failedRequest) {
      _push(`<div class="bg-orange-100 text-orange-700 px-4 py-3 rounded-md mb-4 flex items-center" data-v-78847de2>`);
      _push(ssrRenderComponent(_component_AlertCircleIcon, {
        size: 20,
        class: "mr-2"
      }, null, _parent));
      _push(`<span data-v-78847de2>Une erreur est survenue, veuillez réessayer plus tard.</span></div>`);
    } else {
      _push(`<!---->`);
    }
    _push(`<div class="space-y-4" data-v-78847de2><div data-v-78847de2><label class="block text-sm font-medium text-gray-700 mb-1" data-v-78847de2>Votre nom ou organisation</label><input type="text" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Votre nom complet"${ssrRenderAttr("value", $data.visitorname)} required data-v-78847de2></div><div data-v-78847de2><label class="block text-sm font-medium text-gray-700 mb-1" data-v-78847de2>Adresse email *</label><input type="email" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="exemple@email.com"${ssrRenderAttr("value", $data.visitoremail)} required data-v-78847de2></div><div data-v-78847de2><label class="block text-sm font-medium text-gray-700 mb-1" data-v-78847de2>Votre message</label><textarea rows="4" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Comment pouvons-nous vous aider ?" required data-v-78847de2>${ssrInterpolate($data.visitormessage)}</textarea></div><div data-v-78847de2><label class="block text-sm font-medium text-gray-700 mb-1" data-v-78847de2>Numéro de téléphone (optionnel)</label><input type="tel" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="+243 XXX XXX XXX"${ssrRenderAttr("value", $data.visitorphone)} data-v-78847de2></div><button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center" data-v-78847de2>`);
    _push(ssrRenderComponent(_component_SendIcon, {
      size: 18,
      class: "mr-2"
    }, null, _parent));
    _push(` Envoyer le message </button></div></form><div class="lg:w-1/2" data-v-78847de2><div class="bg-gray-100 rounded-xl overflow-hidden shadow-md h-full" data-v-78847de2><div class="p-4 bg-blue-600 text-white" data-v-78847de2><h3 class="font-semibold flex items-center" data-v-78847de2>`);
    _push(ssrRenderComponent(_component_MapPinIcon, {
      size: 20,
      class: "mr-2"
    }, null, _parent));
    _push(` Localisation de notre bureau </h3><p class="text-sm mt-1" data-v-78847de2>Goma, Nord-Kivu, République Démocratique du Congo</p></div><div class="h-80 md:h-96" data-v-78847de2><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d12151.406270284722!2d29.17910752382813!3d-1.6550603461538438!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2scd!4v1773319308733!5m2!1sen!2scd" width="100%" height="100%" style="${ssrRenderStyle({ "border": "0" })}" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-b-xl" data-v-78847de2></iframe></div><div class="p-4 bg-gray-50 text-center" data-v-78847de2><p class="text-sm text-gray-600" data-v-78847de2>`);
  ...
  _push(`<div class="py-8 md:py-10 border-t border-gray-200 dark:border-dark-border" data-v-78847de2><div class="flex flex-col md:flex-row justify-between items-start gap-8" data-v-78847de2><div class="flex flex-col items-center md:items-start text-center md:text-left max-w-md mx-auto md:mx-0" data-v-78847de2><a href="/" class="mb-4" data-v-78847de2><img${ssrRenderAttr("src", $data.logoImg)} class="w-28 md:w-32 object-contain" alt="Beat Expertise Logo" data-v-78847de2></a><p class="text-gray-600 dark:text-gray-400 text-sm md:text-base" data-v-78847de2> BEAT est un bureau d&#39;expertise et accompagnement technique basé à Goma, dédié à offrir des solutions innovantes pour le développement technologique de la région. </p></div><nav class="flex flex-col items-center md:items-start space-y-3 text-gray-700 dark:text-gray-300 mx-auto md:mx-0" data-v-78847de2><h3 class="font-semibold text-gray-800 dark:text-dark-text mb-2 text-center md:text-left" data-v-78847de2>Navigation</h3><a href="/blogs" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-78847de2>Actualités</a><a href="/#mission" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-78847de2>Mission</a><a href="/#domaines" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-78847de2>Domaines</a><a href="/opportunities" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-78847de2>Offres &amp; Opportunités</a><a href="/apropos" class="hover:text-blue-600 transition-colors text-sm md:text-base" data-v-78847de2>À propos de nous</a></nav><div class="bg-gray-50 dark:bg-dark-surface rounded-lg p-4 md:p-6 max-w-md w-full mx-auto md:mx-0 border border-gray-200 dark:border-dark-border" data-v-78847de2><form class="space-y-3" data-v-78847de2>`);
  if ($data.addedUser) {
    _push(`<div class="bg-green-100 text-green-700 px-3 py-2 rounded-md text-xs md:text-sm flex items-center" data-v-78847de2>`);
    _push(ssrRenderComponent(_component_CheckCircleIcon, {
      size: 16,
      class: "mr-1"
    }, null, _parent));
    _push(`<span data-v-78847de2>Merci d&#39;avoir rejoint notre communauté</span></div>`);
  } else {
    _push(`<!---->`);
  }
  if ($data.userExists) {
    _push(`<div class="bg-orange-100 text-orange-700 px-3 py-2 rounded-md text-xs md:text-sm flex items-center" data-v-78847de2>`);
    _push(ssrRenderComponent(_component_AlertCircleIcon, {
      size: 16,
      class: "mr-1"
    }, null, _parent));
    _push(`<span data-v-78847de2>Cette adresse mail est déjà enregistrée</span></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<h3 class="font-semibold text-gray-800 dark:text-dark-text text-center text-sm md:text-base" data-v-78847de2>Rejoindre notre newsletter</h3><div class="flex" data-v-78847de2><input type="email" class="flex-grow px-3 md:px-4 py-2 rounded-l-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base" placeholder="Votre adresse email"${ssrRenderAttr("value", $data.email)} required data-v-78847de2><button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-3 md:px-4 py-2 rounded-r-lg transition-colors duration-300 flex items-center" data-v-78847de2>`);
  _push(ssrRenderComponent(_component_ArrowRightIcon, { size: 16 }, null, _parent));
  _push(`</button></div><p class="text-xs text-gray-500 text-center" data-v-78847de2>Restez informé de nos dernières actualités</p></form></div></div></div><div class="py-4 md:py-6 border-t border-gray-200 dark:border-dark-border" data-v-78847de2><div class="flex flex-col md:flex-row justify-between items-center gap-4" data-v-78847de2><div class="flex flex-wrap justify-center gap-2" data-v-78847de2><!--[-->`);
  ssrRenderList($data.socialLinks, (social, index) => {
    _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-icon" data-v-78847de2>`);
  ...
  _push(`<!--]--></div><div class="text-center text-gray-600 text-sm" data-v-78847de2> © ${ssrInterpolate($data.year)} <a href="/apropos" class="hover:text-blue-600 transition-colors" data-v-78847de2>Beat Expertise</a>. Tous droits réservés </div></div></div></footer>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-78847de2"]]);
export {
...
//# sourceMappingURL=Footer-CE-b5O4y.js.map
